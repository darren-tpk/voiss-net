...
axs2[0].plot(tmpl, rmsp, color='k', alpha=0.8)
axs2[0].axhline(y=rmsp_mm, color='r', linewidth=2.5, linestyle='--')
axs2[0].set_ylabel('$Pa_{RMS}$', fontsize=22)
axs2[0].set_ylim([0,50])
...
plt.savefig('/Users/darrentpk/Desktop/GitHub/tremor_ml/figures/infrasound_metrics.png',bbox_inches='tight',transparent=False)
fig.show()