...
location = ''
channel = '*HZ'
starttime = UTCDateTime(2021, 9, 14, 10)  # start time for data pull and spectrogram plot
endtime = starttime + 3*60  # end time for data pull and spectrogram plot
...
plot_spectrogram(stream, starttime, endtime, window_duration, freq_lims, log=log, demean=demean, v_percent_lims=v_percent_lims, export_path=export_path, figsize=(20,9))
...
location = ''
channel = 'BDF'
starttime = UTCDateTime(2021, 7, 25, 6, 0)  # start time for data pull and spectrogram plot
