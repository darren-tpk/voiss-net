...
ax.plot([labeled_start_index, matrix_length], [30, 30], 'k-', linewidth=5.5)
ax.plot([labeled_start_index, matrix_length], [35, 35], 'k-', linewidth=5.5)
ax.plot([0, labeled_end_index], [35, 35], 'k-', linewidth=5.5)
ax.plot([0, labeled_end_index], [40, 40], 'k-', linewidth=5.5)
...
# plt.savefig('/Users/darrentpk/Desktop/timeline6.pdf')
plt.show()
...
ax.plot([0, labeled_end_index], [7, 7], 'k-', linewidth=5.5)
...
ax.patch.set_linewidth(2)
ax.set_title('Timeline for Pavlof Seismic Tremor (2021/01/01 to 2022/12/31)', fontsize=30)
plt.savefig('/Users/darrentpk/Desktop/timeline_condensed.png', transparent=True)
plt.savefig('/Users/darrentpk/Desktop/timeline_condensed.pdf')
plt.show()
...
ax.patch.set_linewidth(2)
# ax.set_title('Timeline for Pavlof Seismic Tremor (2021-01-01 to 2022-12-31)', fontsize=30)
plt.savefig('/Users/darrentpk/Desktop/timeline_horiz.pdf',bbox_inches = 'tight')
plt.savefig('/Users/darrentpk/Desktop/timeline_horiz.png',bbox_inches = 'tight',transparent=True)
plt.show()
