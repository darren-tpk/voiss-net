...
npy_dir = '/data/generalized_tremor/labeled_npy_2min_all/'
...
# Define model name
MODEL_TYPE = '2min_all_augmented_noise20'
...
history_name = repo_dir + 'models/' + MODEL_TYPE + '_history.npz'
...
test_params = {
    ...
    "n_classes": len(unique_classes),
    "shuffle": False}# Use saved model to make predictions
...
#save model history and predictions for later analysis
np.savez(history_name, history=history.history, true_labs=true_labs, 
         pred_labs=pred_labs, es_patience=es.patience)
