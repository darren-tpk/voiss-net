...
balance_type = 'subsampled0'  # 'oversampled', 'undersampled', or 'subsampled[1,2,3,4,5]'
random.seed(930)

# Train station-generic model, as mainly PS4A and PVV detect tremor
station_option = 'all'
...
print(metrics_chunk)
with open("output_infra.txt", "a") as outfile:
