...
# starttime = UTCDateTime(2021, 8, 19, 5, 0, 0)
# starttime = UTCDateTime(2021, 8, 18, 3, 0, 0)
# starttime = UTCDateTime(2021, 2, 1, 21, 0, 0)
starttime = UTCDateTime(2021, 1, 3, 6, 0, 0)
...
# Load and predict using station generic model
spec_paths_full = glob.glob('/Users/darrentpk/Desktop/pavlof_2021_2022_infra_npy/*.npy')
spec_paths = []
...
model_filename = '/Users/darrentpk/Desktop/GitHub/tremor_ml/models/4min_all_infra'
if balance_training:
...
# plt.savefig('/Users/darrentpk/Desktop/timeline_checker_infra.png', transparent=True)
# plt.savefig('/Users/darrentpk/Desktop/timeline_checker.pdf')
plt.show()
