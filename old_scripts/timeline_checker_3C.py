...
starttime = UTCDateTime(2022, 1, 23, 12, 0, 0)
...
if model_used == 'station-generic':
    spec_paths_full = glob.glob('/Users/darrentpk/Desktop/all_npy_3C/*.npy')
    spec_paths = []
    ...
    model_filename = model_filename + '_3C_model.h5'
    ...
    for station in stations:
        spec_paths_full = glob.glob('/Users/darrentpk/Desktop/all_npy_3C/*' + station + '*.npy')
        spec_paths = []
        for spec_path in spec_paths_full:
            utc = UTCDateTime(spec_path.split('/')[-1].split('_')[1])
            spec_station = spec_path.split('/')[-1].split('_')[0]
...
plt.savefig('/Users/darrentpk/Desktop/timeline_checker.png', transparent=True)
