...
if model_used == 'station-generic':
    spec_paths = glob.glob('/Users/darrentpk/Desktop/all_npy_3C/*.npy')
    ...
    if balance_training:
        saved_model = load_model('/Users/darrentpk/Desktop/GitHub/tremor_ml/models/4min_all' + '_' + balance_type + '_3C_model.h5')
    else:
        saved_model = load_model('/Users/darrentpk/Desktop/GitHub/tremor_ml/models/4min_all_3C_model.h5')
    ...
    for station in stations:
        spec_paths = glob.glob('/Users/darrentpk/Desktop/all_npy_3C/*' + station + '*.npy')
        spec_placeholder_labels = [0 for i in spec_paths]
        spec_label_dict = dict(zip(spec_paths, spec_placeholder_labels))
        spec_gen = DataGenerator(spec_paths, spec_label_dict, **params)
        if balance_training:
            saved_model = load_model('/Users/darrentpk/Desktop/GitHub/tremor_ml/models/4min_' + station + '_' + balance_type + '_3C_model.h5')
        else:
            saved_model = load_model('/Users/darrentpk/Desktop/GitHub/tremor_ml/models/4min_' + station + '_3C_model.h5')
        spec_predictions = saved_model.predict(spec_gen)
        predicted_labels = np.argmax(spec_predictions, axis=1)  # why are the lengths different?
        for i, filepath in enumerate(spec_gen.list_ids):
            filename = filepath.split('/')[-1]
...
labeled_spec_paths = glob.glob('/Users/darrentpk/Desktop/labeled_npy_4min_3C/*.npy')
indicators2 = []
...
plt.savefig('/Users/darrentpk/Desktop/Github/tremor_ml/figures/timeline' + '_' + tag + '_3C.pdf')
plt.savefig('/Users/darrentpk/Desktop/Github/tremor_ml/figures/timeline' + '_' + tag + '_3C.png')
plt.show()
...
ax.patch.set_linewidth(2)
ax.set_title('Timeline for Pavlof Seismic Tremor (2021/01/01 to 2022/12/31)', fontsize=30)
plt.savefig('/Users/darrentpk/Desktop/Github/tremor_ml/figures/timeline_condensed' + '_' + tag + '_3C.png', transparent=True)
plt.savefig('/Users/darrentpk/Desktop/Github/tremor_ml/figures/timeline_condensed' + '_' + tag + '_3C.pdf')
plt.show()
...
ax.patch.set_linewidth(2)
# ax.set_title('Timeline for Pavlof Seismic Tremor (2021-01-01 to 2022-12-31)', fontsize=30)
plt.savefig('/Users/darrentpk/Desktop/Github/tremor_ml/figures/timeline_horiz' + '_' + tag + '_3C.pdf',bbox_inches = 'tight')
plt.savefig('/Users/darrentpk/Desktop/Github/tremor_ml/figures/timeline_horiz' + '_' + tag + '_3C.png',bbox_inches = 'tight',transparent=True)
plt.show()
