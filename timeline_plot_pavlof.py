...
end_month = UTCDateTime(2013,9,30)
...
export_path = '/Users/darrentpk/Desktop/Github/tremor_ml/figures/pavlof2013.png'
...
plot_title = 'Timeline for Pavlof Seismic Tremor (%s to %s)' % (start_month.strftime('%Y-%m-%d'),end_month.strftime('%Y-%m-%d'))
export_path = '/Users/darrentpk/Desktop/Github/tremor_ml/figures/pavlof2014.png'
plot_timeline(start_month, end_month, time_step, type, model_path, meanvar_path, npy_dir, plot_title,
              export_path=export_path, transparent=False)
...
plot_title = 'Timeline for Pavlof Seismic Tremor (%s to %s)' % (start_month.strftime('%Y-%m-%d'),end_month.strftime('%Y-%m-%d'))
export_path = '/Users/darrentpk/Desktop/Github/tremor_ml/figures/pavlof2016.png'
plot_timeline(start_month, end_month, time_step, type, model_path, meanvar_path, npy_dir, plot_title,
              export_path=export_path, transparent=False)
...
plot_title = 'Timeline for Pavlof Seismic Tremor (%s to %s)' % (start_month.strftime('%Y-%m-%d'),end_month.strftime('%Y-%m-%d'))
export_path = '/Users/darrentpk/Desktop/Github/tremor_ml/figures/pavlof2021.png'
plot_labels = True
