...
def plot_timeline(starttime, endtime, time_step, type, model_path, indicators_path, plot_title, export_path=None, transparent=False, fig_width=None, fig_height=None, font_s=18, plot_stations=None, plot_labels=False, labels_kwargs=None):
    """
